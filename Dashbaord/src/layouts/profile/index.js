          ...
          <Grid container spacing={1}>
            ...
            <Grid item xs={12} md={6} xl={4} sx={{ display: "flex" }}>
              ...
              <ProfileInfoCard
                ...
                description="Hi, I’m SHubham Raj, Decisions: If you can’t decide, the answer is no. If two equally difficult paths, choose the one more painful in the short term (pain avoidance is creating an illusion of equality)."
                info={{
                ...
                social={[
                  {
                    link: "https://www.linkedin.com/in/shubham1raj/",
                    icon: <FacebookIcon />,
                    color: "facebook",
                  },
                  {
